...
interface InfiniteSpinnerProps extends SpinnerVariantProps {
  animationDuration?: string;
}

const Infinite = ({ size = 24, animationDuration = "2s", className, ...props }: InfiniteSpinnerProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Spinner = ({ variant, animationDuration, ...props }: SpinnerProps) => {
  switch (variant) {
    case 'circle':
      return <Circle {...props} />;
    case 'pinwheel':
    ...
    case 'bars':
      return <Bars {...props} />;
    case 'infinite':
      return <Infinite {...props} animationDuration={animationDuration} />;
    default:
